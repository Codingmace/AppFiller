...
def apply(driver , url):
	...
	time.sleep(3)
#	try:
#		ale = driver.switch_to_alert().accept()
#		time.sleep(1)
#		ale.accept()
#		driver.get(url)
#		time.sleep(1)
...
#		if lastCount1 == lastCount2 and lastCount2 == len(elements):
#			steps = 8
#			break
#		lastCount2 = lastCount1
#		lastCount1 = len(elements)
...
#apply(driver)
# Spidering
#fullList = getLinks('devops+engineer', 600)
